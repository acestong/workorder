 ...
 **/
@Data
public class ProjectFlowChangeProjectConditionTypeModel {
    ...
    public ProjectFlowChangeProjectConditionTypeModel() {
    }

    public ProjectFlowChangeProjectConditionTypeModel(ProjectFlowChangeProjectConditionTypeEnum typeEnum) {
