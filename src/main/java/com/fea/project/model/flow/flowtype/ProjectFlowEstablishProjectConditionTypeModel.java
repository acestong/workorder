 ...
 **/
@Data
public class ProjectFlowEstablishProjectConditionTypeModel {
    ...
    public ProjectFlowEstablishProjectConditionTypeModel() {
    }

    public ProjectFlowEstablishProjectConditionTypeModel(ProjectFlowEstablishProjectConditionTypeEnum typeEnum) {
