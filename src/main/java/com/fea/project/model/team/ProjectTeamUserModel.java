 ...
 */
@Data
@TableNameAnno(value = "t_project_team_user")
public class ProjectTeamUserModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public ProjectTeamUserModel() {
    }

    public ProjectTeamUserModel(ProjectUserModel projectUserModel, Long teamId, SysUserModel sysUserModel) {
        this.teamId = teamId;
        this.userId = projectUserModel.getId();
        this.startTime = projectUserModel.getCreateTime();
        this.setUserInfo(sysUserModel, ActionEnum.INSERT_ACTION);
        this.delStatus = DeleteStatusEnum.NOT_DELETE.getStatus();
    }

    public ProjectTeamUserModel(Long teamId) {
        this.teamId = teamId;
    }

    public ProjectTeamUserModel(ProjectTeamUserPojo model, Long tmp) {
        this.teamId = model.getTeamId();
        this.userId = tmp;
        this.startTime = model.getStartTime();
        this.endTime = model.getEndTime();
        this.duration = model.getDuration();
        this.timePercent = model.getTimePercent();
    }

    public ProjectTeamUserModel(Long userId, Long teamId, SysUserModel userModel) {
        this.teamId = teamId;
        this.userId = userId;
    ...
    public static ProjectTeamUserModel createProjectTeamUserModel(Long projectUserId, SysUserModel userModel, Integer delStatus) {
        ProjectTeamUserModel model = new ProjectTeamUserModel();
