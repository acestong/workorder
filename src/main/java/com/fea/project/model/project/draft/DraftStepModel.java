package com.fea.project.model.project.draft;
...
public class DraftStepModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public DraftStepModel (Long id, Long projectId, String name, Integer index, Date startTime, Date endTime, Integer duration, Long leader, String content, String deliverClaim, Integer isSubmit, Long createId, String createBy, Date createTime, Long updateId, String updateBy, Date updateTime, Integer delStatus, Long originalId, Long draftId) {
        this.id = id;
    ...
    public DraftStepModel () {

    }

    public DraftStepModel(ProjectStepVo projectStepVo) {
    ...
    public DraftStepModel(Long draftId) {
        this.draftId = draftId;
    }
