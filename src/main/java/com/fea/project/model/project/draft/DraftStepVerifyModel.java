...
public class DraftStepVerifyModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public DraftStepVerifyModel () {
        
    }

    public DraftStepVerifyModel(ProjectStepVerifyModel projectStepVerifyModel) {
