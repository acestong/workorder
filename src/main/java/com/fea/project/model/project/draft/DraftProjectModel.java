...
public class DraftProjectModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public DraftProjectModel () {
    }

    public DraftProjectModel(ProjectVo projectVo, Long userId) {
    ...
    public DraftProjectModel(Long id) {
        this.id = id;
    }

    public DraftProjectModel(Long id, Integer verifyStatus) {
        this.id = id;
