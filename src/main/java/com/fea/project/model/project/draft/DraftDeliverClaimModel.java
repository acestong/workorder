 ...
 */
@Data
@TableNameAnno(value = "t_project_deliver_claim")
public class DraftDeliverClaimModel implements Serializable {
    /**
     * 版本号
     */
     ...
     */
    @JsonFormat(shape = JsonFormat.Shape.STRING)
    @ConditionStatusAnno(field = "draft_id")
    protected Long draftId;


    public DraftDeliverClaimModel () {
        
    }

    public DraftDeliverClaimModel(ProjectDeliverClaimVo projectDeliverClaimVo) {
