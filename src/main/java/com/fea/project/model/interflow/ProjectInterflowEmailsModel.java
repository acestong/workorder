 ...
 */
public class ProjectInterflowEmailsModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public ProjectInterflowEmailsModel (Long id, String title, Integer type, Integer way, Integer contactType, Long contactId, Date time, String details, Long createId, String createBy, Date createTime, Long updateId, String updateBy, Date updateTime, Integer delStates, Long projectId, Long projectStep, Long taskId) {
        this.id = id;
        this.title = title;
        this.type = type;
        this.way = way;
    ...
    public ProjectInterflowEmailsModel(Long id) {
        this.id = id;
    }

    public ProjectInterflowEmailsModel () {
    ...
    public boolean equals(Object that) {
        ...
        ProjectInterflowEmailsModel other = (ProjectInterflowEmailsModel) that;
