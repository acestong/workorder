 ...
 */
@Data
@TableNameAnno(value = "t_project_role")
public class ProjectRoleModel implements Serializable {
    ...
    public ProjectRoleModel(ProjectDefaultRoleEnum typeProjectAdmin, SysUserModel sysUserModel, ProjectModel projectModel, ActionEnum actionEnum) {
    ...
    public ProjectRoleModel(Long projectId) {
