 ...
 */
@Builder
public class ProjectProductAppendixModel implements Serializable {
    /**
     * 版本号
     */
    ...
    public ProjectProductAppendixModel () {
        
    }

    public ProjectProductAppendixModel(Long id, Long appendixId, String type, Long businessId, String businessName, Long createId, String createBy, Date createTime, Long updateId, String updateBy, Date updateTime, Integer delStatus, String name, String realName, String fileSize, String url) {
        this.id = id;
    ...
    public boolean equals(Object that) {
        ...
        ProjectProductAppendixModel other = (ProjectProductAppendixModel) that;
