...
//TODO
@Service
public class ProjectBusinessTeamerPlanApplyImplService extends AbstractFlowApply<PlanModel> {
	...
	protected Integer getFlowTypeId() {
		// TODO Auto-generated method stub
		return ProjectConfigEnum.VERIFY_SET_PROJECT_TEAMER_PLAN_VERIFY.getValue();
	}
	@Override
	...
	protected void setProjectApplyConnectBusinessInfo(ProjectApplyPojo projectApplyPojo, PlanModel model) {
        ...
        projectApplyPojo.setApplyType(ProjectFlowTypeEnum.VERIFY_SET_PROJECT_TEAMER_PLAN_VERIFY.getValue());
