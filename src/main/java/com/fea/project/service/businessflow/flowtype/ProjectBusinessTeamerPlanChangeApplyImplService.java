...
//TODO
@Service
public class ProjectBusinessTeamerPlanChangeApplyImplService extends AbstractFlowApply<PlanModel> {
	...
	protected Integer getFlowTypeId() {
		// TODO Auto-generated method stub
		return ProjectConfigEnum.CHANGE_APPLY_PROJECT_TEAMER_PLAN_CHANGE_VERIFY.getValue();
	}
	...
	protected void setProjectApplyConnectBusinessInfo(ProjectApplyPojo projectApplyPojo, PlanModel model) {
        ...
        projectApplyPojo.setApplyType(ProjectFlowTypeEnum.CHANGE_APPLY_PROJECT_TEAMER_PLAN_CHANGE_VERIFY.getValue());
